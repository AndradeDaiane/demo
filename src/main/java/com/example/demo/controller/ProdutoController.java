...
import com.example.demo.model.Produto; // Importa o modelo Produto.
import com.example.demo.service.ProdutoService; // Importa o serviço ProdutoService para lógica de negócios.
